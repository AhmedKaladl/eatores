...
class SubscriptionCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
      ...
      ClipRRect(
        ...
        child: Stack(
          children: [
            ...
            //     child: Text('${package.packageName}', style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.FONT_SIZE_OVER_LARGE, color: Theme.of(context).cardColor)),
            //   ),
            // ),
      ...
      Text(
        PriceConverter.convertPrice(package.price), textDirection: TextDirection.rtl,
    ...
    return Column(children: [
      Padding(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.start, children: [
          ...
          Text(title, style: IBMPlexSansArabicMedium),
        ]),
      ),
