              ...
              child: SizedBox(
                ...
                child: GetBuilder<AuthController>(builder: (authController) {
                  ...
                  return Column(children: [
                    ...
                    Text('sign_in'.tr.toUpperCase(), style: IBMPlexSansArabicBlack.copyWith(fontSize: 30)),
                    ...
                    Get.find<SplashController>().configModel!.toggleRestaurantRegistration! ? TextButton(
                      ...
                      child: RichText(text: TextSpan(children: [
                        TextSpan(text: '${'join_as'.tr} ', style: IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).secondaryHeaderColor)),
                        TextSpan(text: 'restaurant'.tr, style: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).primaryColor)),
                      ])),
                    ) : const SizedBox(),
