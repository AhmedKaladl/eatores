  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        /*title: Text(AppConstants.APP_NAME, maxLines: 1, overflow: TextOverflow.ellipsis, style: IBMPlexSansArabicMedium.copyWith(
            ...
            GetBuilder<AuthController>(builder: (authController) {
              return Column(children: [
                Container(
                  ...
                  child: Row(children: [
                    Expanded(child: Text(
                      'restaurant_temporarily_closed'.tr, style: IBMPlexSansArabicMedium,
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Text(
                          ...
                          style: IBMPlexSansArabicBold.copyWith(fontSize: 24, color: Theme.of(context).cardColor), textDirection: TextDirection.rtl,
                        ),
                      ]),
                    ]),
                    ...
                    Row(children: [
                      Expanded(child: Column(children: [
                        ...
                        Text(
                          ...
                          style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeExtraLarge, color: Theme.of(context).cardColor), textDirection: TextDirection.rtl,
                        ),
                      ])),
