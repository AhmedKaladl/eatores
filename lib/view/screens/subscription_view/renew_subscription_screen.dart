            ...
            InkWell(
              ...
              child: Container(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text(
                      title, style: IBMPlexSansArabicBold.copyWith(color: authController.refundPaymentIndex == index ? Theme.of(context).primaryColor
                      : Theme.of(context).textTheme.bodyLarge!.color),
                    ),
                    const SizedBox(height: Dimensions.paddingSizeSmall),

                    Text(
                      subTitle, style: IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color),
                    ),
