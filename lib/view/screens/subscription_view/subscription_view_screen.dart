...
class _SubscriptionViewScreenState extends State<SubscriptionViewScreen> with TickerProviderStateMixin {
          ...
          builder: (authController) {
            return authController.profileModel != null ? SingleChildScrollView(
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Stack(children: [
                  Column(children: [
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      Text('billing_details'.tr, style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
                  ...
                  && Get.find<SplashController>().configModel!.businessPlan!.subscription != 0) ? Container(
                    ...
                    child: Column(children: [
                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        Text('attention'.tr, style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).cardColor)),
                        IconButton(
                ...
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  Text('subscription_plan'.tr, style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
                ...
                Padding(
                  ...
                  child: Column(children: [
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      Text(authController.profileModel!.subscription!.package!.packageName!, style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Colors.blue)),

                      Row(crossAxisAlignment: CrossAxisAlignment.end,children: [
                        Text(
                            '${PriceConverter.convertPrice(authController.profileModel!.subscription!.package!.price)}/',
                                style: IBMPlexSansArabicBold.copyWith(fontSize: Dimensions.fontSizeOverLarge),
                          textDirection: TextDirection.rtl,
                        ),
                        Text(
                          '${authController.profileModel!.subscription!.package!.validity} ${'days'.tr}',
                          style: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color!.withOpacity(0.5), fontSize: Dimensions.fontSizeDefault),
                        ),
                      ]),
                    ]),
  ...
  Widget planTile({required String title1, required String title2}){
    return Row(children: [
      ...
      Text(title1, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeDefault)),
      Text(title2, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge!.color!.withOpacity(0.5)))
    ]);
  }
  ...
  Widget billingCard({required String logo, required String title, required String subTitle, bool titleBig = false, bool subtitleSmall = false}){
    return Row(children: [
      ...
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text(title, style: IBMPlexSansArabicMedium.copyWith(
        ...
        Text(subTitle, style: IBMPlexSansArabicBold.copyWith(fontSize: subtitleSmall ? Dimensions.fontSizeSmall : Dimensions.fontSizeExtraLarge)),
      ]),
    ]);
  }
}
