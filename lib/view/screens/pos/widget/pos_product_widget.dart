                      ...
                      Expanded(
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                          ...
                          Text(
                            ...
                            style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeSmall), textDirection: TextDirection.rtl,
                          ),
                        ]),
                      ),
                        ...
                        itemBuilder: (context, index) {
                          return Padding(
                            ...
                            child: Row(children: [
                              ...
                              Text(addOns[index].name, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.FONT_SIZE_EXTRA_SMALL)),
                              SizedBox(width: 2),
                              Text(
                                PriceConverter.convertPrice(addOns[index].price),
                                style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.FONT_SIZE_EXTRA_SMALL),
                              ),
                              SizedBox(width: 2),
                              Text(
