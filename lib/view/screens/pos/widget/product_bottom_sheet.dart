...
//                       Text(
//                         product.name, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE),
...
//                         style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE),
//                       ),
//                       SizedBox(height: 5),
...
//                       Text(product.choiceOptions[index].title, style: IBMPlexSansArabicMedium),
//                       SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
//                       GridView.builder(
...
//                 // Quantity
//                 Row(children: [
//                   Text('quantity'.tr, style: IBMPlexSansArabicMedium),
...
//                       isIncrement: false,
//                     ),
//                     Text(posController.quantity.toString(), style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
//                     QuantityButton(
...
//                                   style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL),
//                                 ),
//                                 Expanded(
//                                   child: InkWell(
...
//
//                 Row(children: [
//                   Text('${'total_amount'.tr}:', style: IBMPlexSansArabicMedium),
//                   SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
//                   Text(PriceConverter.convertPrice(priceWithAddons), style: IBMPlexSansArabicBold.copyWith(color: Theme.of(context).primaryColor)),
//                 ]),
//                 SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
//
//                 //Add to cart Button
...
//                     'restaurant_is_closed_now'.tr, style: IBMPlexSansArabicMedium.copyWith(
//                     color: Theme.of(context).primaryColor, fontSize: Dimensions.FONT_SIZE_LARGE,
//                   ),
//                   ) : Column(children: [
//                     Text('not_available_now'.tr, style: IBMPlexSansArabicMedium.copyWith(
//                       color: Theme.of(context).primaryColor, fontSize: Dimensions.FONT_SIZE_LARGE,
//                     )),
//                     Text(
