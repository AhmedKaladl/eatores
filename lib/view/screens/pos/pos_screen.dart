              ...
              child: Row(children: [
                ...
                Expanded(
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text(suggestion.name!, maxLines: 1, overflow: TextOverflow.ellipsis, style: IBMPlexSansArabicRegular.copyWith(
                      color: Theme.of(context).textTheme.bodyLarge!.color, fontSize: Dimensions.fontSizeLarge,
                    )),
                    Text(PriceConverter.convertPrice(suggestion.price), style: IBMPlexSansArabicRegular.copyWith(
                      ...
                      child: SizedBox(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            ...
                            Text(PriceConverter.convertPrice(itemPrice), style: IBMPlexSansArabicRegular, textDirection: TextDirection.rtl,),
                          ]),
                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            Text('subtotal'.tr, style: IBMPlexSansArabicMedium),
                            Text(PriceConverter.convertPrice(subTotal), style: IBMPlexSansArabicMedium, textDirection: TextDirection.rtl,),
                          ]),
                          const SizedBox(height: Dimensions.paddingSizeSmall),
                          Row(children: [
                            Expanded(child: Text('discount'.tr, style: IBMPlexSansArabicRegular)),
                            SizedBox(
                              width: 70,
                              child: MyTextField(
                                title: false,
