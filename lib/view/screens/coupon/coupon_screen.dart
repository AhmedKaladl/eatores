          ...
          builder: (couponController) {
            return couponController.coupons != null ? couponController.coupons!.isNotEmpty ? ListView.builder(
                          ...
                          Expanded(
                            ...
                            child: Padding(
                              ...
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                ...
                                Text('${'code'.tr}: ${couponController.coupons![index].code!}', style: IBMPlexSansArabicMedium),
                                const SizedBox(height: 5),

                                Text('${'total_users'.tr}: ${couponController.coupons![index].totalUses}', style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall)),
                                const SizedBox(height: 5),
              ...
              /*return ListTile(
                ...
                title: Row(
                  children: [
                    Text(couponController.coupons[index].title, style: IBMPlexSansArabicMedium),
                ...
                subtitle: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Text('${'start_date'.tr + ': ' + couponController.coupons[index].startDate} / ${'expire_date'.tr + ': ' + couponController.coupons[index].expireDate}',
                    style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.FONT_SIZE_EXTRA_SMALL),
                  ),
                  ...
                  Text('${'total_users'.tr + ': ' + couponController.coupons[index].totalUses.toString()}', style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.FONT_SIZE_EXTRA_SMALL)),
                    ...
                    children: [
                      ...
                      PopupMenuButton(
                        itemBuilder: (context) {
                          return <PopupMenuEntry>[
                            PopupMenuItem(
                              child: Text('edit'.tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL)),
                              value: 'edit',
                            ),
                            PopupMenuItem(
                              child: Text('delete'.tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL, color: Colors.red)),
                              value: 'delete',
                            ),
                          ];
                        },
