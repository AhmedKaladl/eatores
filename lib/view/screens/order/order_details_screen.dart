          ...
          body: (orderController.orderDetailsModel != null && controllerOrderModel != null && restaurant != null) ? Column(children: [
            ...
            Expanded(child: Scrollbar(child: SingleChildScrollView(
              ...
              child: Center(child: SizedBox(width: 1170, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                && controllerOrderModel.orderStatus != 'refunded' && controllerOrderModel.orderStatus != 'refund_request_canceled') ? Column(children: [
                  ...
                  Text('food_need_to_delivered_within'.tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).disabledColor)),
                ...
                Row(children: [
                  Text('${'order_type'.tr} ${':'} ${order.orderType!.tr}', style: IBMPlexSansArabicMedium),
                  const Expanded(child: SizedBox()),
                  Container(
                    ...
                    child: Text(
                      ...
                      style: IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeExtraSmall),
                    ),
                  ),
                ]),
                ...
                subscription ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Row(children: [
                    ...
                    const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                    Text(orderController.subscriptionModel!.type!.tr, style: IBMPlexSansArabicMedium),
                  ]),
                  const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                ...
                Text('customer_details'.tr, style: IBMPlexSansArabicRegular),
                const SizedBox(height: Dimensions.paddingSizeSmall),
                ...
                Row(children: [
                  ...
                  Expanded(child: order.deliveryAddress != null ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Wrap(children: [
                      ...
                      (order.deliveryAddress?.house != null && order.deliveryAddress!.house!.isNotEmpty) ? Text('${'house'.tr}: ${order.deliveryAddress!.house!}${(order.deliveryAddress!.floor != null && order.deliveryAddress!.floor!.isNotEmpty) ? ', ' : ' '}',
                        style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor), maxLines: 1, overflow: TextOverflow.ellipsis,
                      ) : const SizedBox(),
                  ...
                  ]) : Text('walking_customer'.tr, style: IBMPlexSansArabicMedium)),
                ...
                order.deliveryMan != null ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Text('delivery_man'.tr, style: IBMPlexSansArabicRegular),
                  const SizedBox(height: Dimensions.paddingSizeSmall),
                ...
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  Text(PriceConverter.convertPrice(subTotal), style: IBMPlexSansArabicMedium, textDirection: TextDirection.rtl),
                ]),
                const SizedBox(height: 10),
                ...
                order.paymentMethod == 'partial_payment' ? DottedBorder(
                  ...
                  child: Ink(
                    ...
                    child: Column(children: [
                      ...
                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        Text('${order.payments![1].paymentStatus == 'paid' ? 'paid_by'.tr : 'due_amount'.tr} (${order.payments![1].paymentMethod?.tr})', style: restConfModel ? IBMPlexSansArabicMedium : IBMPlexSansArabicRegular),
                        Text(
            ...
            SafeArea(
              child:  showDeliveryConfirmImage && controllerOrderModel.orderStatus != 'delivered' ? Padding(
                ...
                child: Text('food_is_on_the_way'.tr, style: IBMPlexSansArabicMedium),
                  ...
                  Expanded(child: CustomButton(
                    ...
                    onPressed: () {
                      Get.dialog(ConfirmationDialog(
                        ...
                        onYesPressed: () {
                          orderController.updateOrderStatus(controllerOrderModel.id, 'processing', back: true).then((success) {
                            if(success) {
                              Get.find<AuthController>().getProfile();
