  ...
  Widget build(BuildContext context) {
    return _searchingMode ? SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
            /*
          Text('paper_size'.tr, style: IBMPlexSansArabicMedium),
          Row(children: [
        ...
        Container(
          ...
          child: Screenshot(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, children: [
              ...
              Text(restaurant.name!, style: IBMPlexSansArabicMedium.copyWith(fontSize: fontSize)),
              Text(restaurant.address!, style: IBMPlexSansArabicRegular.copyWith(fontSize: fontSize)),
              Text(restaurant.phone!, style: IBMPlexSansArabicRegular.copyWith(fontSize: fontSize), textDirection: TextDirection.ltr),
              Text(restaurant.email!, style: IBMPlexSansArabicRegular.copyWith(fontSize: fontSize)),
              const SizedBox(height: 10),

              Wrap(
                children: [
                  Row(children: [
                    Text('${'order_id'.tr}:', style: IBMPlexSansArabicRegular.copyWith(fontSize: fontSize)),
                    const SizedBox(width: 5),
                    Text(order!.id.toString(), style: IBMPlexSansArabicMedium.copyWith(fontSize: fontSize)),
                  ]),

                  Text(DateConverter.dateTimeStringToMonthAndTime(order!.createdAt!), style: IBMPlexSansArabicRegular.copyWith(fontSize: fontSize)),
                ],
              ),
              order!.scheduled == 1 ? Text(
                '${'scheduled_order_time'.tr} ${DateConverter.dateTimeStringToDateTime(order!.scheduleAt!)}',
                style: IBMPlexSansArabicRegular.copyWith(fontSize: fontSize),
              ) : const SizedBox(),
              const SizedBox(height: 5),

              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                Text('${'order_type'.tr} ${':'} ${order!.orderType!.tr}', style: IBMPlexSansArabicRegular.copyWith(fontSize: fontSize)),
                Text(order!.paymentMethod!.tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: fontSize)),
              ]),
              Divider(color: Theme.of(context).textTheme.bodyLarge!.color, thickness: 1),

              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text('${order!.customer!.fName} ${order!.customer!.lName}', style: IBMPlexSansArabicRegular.copyWith(fontSize: fontSize)),
                Text(order!.deliveryAddress?.address ?? '', style: IBMPlexSansArabicRegular.copyWith(fontSize: fontSize)),
                Text(order!.deliveryAddress?.contactPersonNumber ?? '', style: IBMPlexSansArabicRegular.copyWith(fontSize: fontSize)),
              ]),
              const SizedBox(height: 10),

              Row(children: [
                Expanded(flex: 1, child: Text('sl'.tr.toUpperCase(), style: IBMPlexSansArabicMedium.copyWith(fontSize: fontSize))),
                Expanded(flex: 5, child: Text('item_info'.tr, style: IBMPlexSansArabicMedium.copyWith(fontSize: fontSize))),
                Expanded(flex: 2, child: Text(
                  'qty'.tr, style: IBMPlexSansArabicMedium.copyWith(fontSize: fontSize),
                  textAlign: TextAlign.center,
                )),
                Expanded(flex: 2, child: Text(
                  'price'.tr, style: IBMPlexSansArabicMedium.copyWith(fontSize: fontSize),
                    ...
                    child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(flex: 5, child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text(
                          ...
                          style: IBMPlexSansArabicMedium.copyWith(fontSize: fontSize),
                        ),
              ...
              Text('thank_you'.tr, style: IBMPlexSansArabicRegular.copyWith(fontSize: fontSize)),
              Divider(color: Theme.of(context).textTheme.bodyLarge!.color, thickness: 1),
...
class PriceWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
      Text(title, style: IBMPlexSansArabicRegular.copyWith(fontSize: fontSize)),
      Text(value, style: IBMPlexSansArabicMedium.copyWith(fontSize: fontSize)),
    ]);
  }
}
