        ...
        Expanded(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [
              ...
              Text('${'quantity'.tr}:', style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeDefault)),
              Text(
      ...
      addOnText.isNotEmpty ? Padding(
        ...
        child: Column ( crossAxisAlignment : CrossAxisAlignment.start, children: [
          ...
          Row( children: [
            ...
            Text(
              addOnText,
              style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).secondaryHeaderColor,
          )),
          ])]),
      ) : const SizedBox(),
