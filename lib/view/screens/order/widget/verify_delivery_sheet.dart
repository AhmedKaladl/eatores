        ...
        return Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            widget.verify! ? Column(children: [
              ...
              Text('otp_verification'.tr, style: IBMPlexSansArabicBold, textAlign: TextAlign.center),
              const SizedBox(height: Dimensions.paddingSizeLarge),

              Text('enter_otp_number'.tr, style: IBMPlexSansArabicRegular, textAlign: TextAlign.center),
              const SizedBox(height: Dimensions.paddingSizeLarge),
              ...
              Text('collect_otp_from_customer'.tr, style: IBMPlexSansArabicRegular, textAlign: TextAlign.center),
              const SizedBox(height: Dimensions.paddingSizeLarge),
            ]) : const SizedBox(),
            ...
            widget.verify! ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              orderController.hideNotificationButton ? const SizedBox() : InkWell(
                ...
                child: Text(
                  'resend_it'.tr,
                  style: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeSmall),
                ),
              )
            ]) : const SizedBox(),
            const SizedBox(height: Dimensions.paddingSizeLarge),
