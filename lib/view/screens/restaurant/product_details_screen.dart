              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(children: [
                  ...
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text(
                      product.name!, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                ...
                Row(children: [
                  Text('daily_time'.tr, style: IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).disabledColor)),
                ...
                Row(children: [
                  ...
                  Text(product.avgRating!.toStringAsFixed(1), style: IBMPlexSansArabicRegular),
                  const SizedBox(width: Dimensions.paddingSizeSmall),
                ...
                (product.variations != null && product.variations!.isNotEmpty) ? Text('variations'.tr, style: IBMPlexSansArabicMedium) : const SizedBox(),
                  ...
                  itemBuilder: (context, index) {
                    return Padding(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Row(children: [
                          Text('${product.variations![index].name!} - ', style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
                          Text(
                ...
                product.addOns!.isNotEmpty ? Text('addons'.tr, style: IBMPlexSansArabicMedium) : const SizedBox(),
                ...
                product.addOns!.isNotEmpty ? ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return Row(children: [
                      ...
                      Text('${product.addOns![index].name!}:', style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                      const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                      Text(
                        PriceConverter.convertPrice(product.addOns![index].price), textDirection: TextDirection.rtl,
                ...
                (product.description != null && product.description!.isNotEmpty) ? Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                    Text(product.description!, style: IBMPlexSansArabicRegular),
                    const SizedBox(height: Dimensions.paddingSizeLarge),
                  ],
                ) : const SizedBox(),

                product.tags != null && product.tags!.isNotEmpty ? Text('tags'.tr, style: IBMPlexSansArabicMedium) : const SizedBox(),
                ...
                product.tags != null && product.tags!.isNotEmpty ? ListView.builder(
                  ...
                  shrinkWrap: true,
                  itemBuilder: (context, index) {
                    return Text(product.tags![index].tag!, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall));
                  },
                ) : const SizedBox(),
                ...
                Get.find<AuthController>().profileModel!.restaurants![0].reviewsSection! ? Column(
                  ...
                  children: [
                    ...
                    haveSubscription ? restController.productReviewList != null ? restController.productReviewList!.isNotEmpty ? ListView.builder(
                      ...
                      child: Center(child: Text('no_review_found'.tr, style: IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).disabledColor))),
                    ) : const Padding(
                      padding: EdgeInsets.only(top: Dimensions.paddingSizeLarge),
                      child: Center(child: CircularProgressIndicator()),
                    ) : Padding(
                      padding: const EdgeInsets.only(top: Dimensions.paddingSizeLarge),
                      child: Center(child: Text('not_available_subscription_for_reviews'.tr, style: IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).disabledColor))),
                    ),
                  ],
                ) : const SizedBox(),
