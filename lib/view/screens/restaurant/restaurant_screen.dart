                ...
                child: Column(children: [
                  Row(children: [
                    ...
                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text(
                        restaurant.name!, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                  ...
                  //     style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.FONT_SIZE_EXTRA_SMALL, color: Theme.of(context).primaryColor),
                  //   ),
                  // ]) : SizedBox(),
