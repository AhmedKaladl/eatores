...
//       Text(
//         'attribute'.tr,
//         style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL, color: Theme.of(context).disabledColor),
//       ),
...
//                 child: Text(
//                   widget.restController.attributeList[index].attribute.name, maxLines: 2, textAlign: TextAlign.center,
//                   style: IBMPlexSansArabicRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge.color),
//                 ),
//               ),
...
//                     ),
//                     child: Row(children: [
//                       Text(widget.restController.attributeList[index].variants[i], style: IBMPlexSansArabicRegular),
//                       InkWell(
...
//                     style: IBMPlexSansArabicRegular, textAlign: TextAlign.center, maxLines: 1,
//                   ),
//                 ),
//               ])),
//               SizedBox(width: Dimensions.PADDING_SIZE_SMALL),
