      ...
      Row(children: [
        ...
        Expanded(child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Text(
            ...
            style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: review.customer != null ? Theme.of(context).textTheme.displayLarge!.backgroundColor : Theme.of(context).disabledColor),
          ),
          ...
          fromRestaurant ? Text(
            ...
            maxLines: 1, overflow: TextOverflow.ellipsis,
            style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: review.customer != null ? Theme.of(context).textTheme.displayLarge as Color? : Theme.of(context).disabledColor),
          ) : const SizedBox(),
          const SizedBox(height: Dimensions.paddingSizeExtraSmall),

          Text(review.comment!, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor)),
