            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                borderRadius: BorderRadius.horizontal(
                  ...
                  right: Radius.circular(
                    ltr ? index == Get.find<RestaurantController>().productTypeList.length-1
              ...
              child: Text(
                ...
                style: Get.find<RestaurantController>().productTypeList[index] == type
                    ? IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).cardColor)
