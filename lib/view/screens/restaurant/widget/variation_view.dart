    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Container(
              ...
              child: Column(children: [
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Text('select_type'.tr, style: IBMPlexSansArabicMedium),
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: Text('add_new_option'.tr, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
                      ),
                    ),
                  ]),
                ),
      ...
      InkWell(
        ...
        child: Container(
          ...
          child: Text(widget.restController.variationList!.isNotEmpty ? 'add_new_variation'.tr : 'add_variation'.tr, style: IBMPlexSansArabicMedium.copyWith(color: Theme.of(context).cardColor, fontSize: Dimensions.fontSizeDefault)),
        ),
      ),
