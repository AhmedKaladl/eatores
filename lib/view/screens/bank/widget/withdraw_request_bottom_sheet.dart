        ...
        builder: (bankController) {
          ...
          return SingleChildScrollView(
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              Text('withdraw'.tr, style: IBMPlexSansArabicMedium),
              ...
              // Text('enter_amount'.tr, style: IBMPlexSansArabicBold.copyWith(color: Theme.of(context).disabledColor)),
              ...
              !bankController.isLoading ? CustomButton(
