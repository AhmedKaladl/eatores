      ...
      body: Center(
        child: Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            //Text(AppConstants.APP_NAME, style: IBMPlexSansArabicMedium.copyWith(fontSize: 25), textAlign: TextAlign.center),
            const SizedBox(height: Dimensions.paddingSizeSmall),
            Text('suffix_name'.tr, style: IBMPlexSansArabicMedium, textAlign: TextAlign.center),
          ]),
        ),
      ),
    );
