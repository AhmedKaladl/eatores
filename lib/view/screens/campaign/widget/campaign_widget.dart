      ...
      child: Container(
        ...
        child: Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            Text(campaignModel.title!, style: IBMPlexSansArabicMedium, maxLines: 1, overflow: TextOverflow.ellipsis),
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child: Text(campaignModel.vendorStatus == null ? 'join_now'.tr : campaignModel.vendorStatus != 'confirmed'
                      ? campaignModel.vendorStatus!.tr : 'leave_now'.tr, textAlign: TextAlign.center, style: IBMPlexSansArabicBold.copyWith(
                    color: Theme.of(context).cardColor,
