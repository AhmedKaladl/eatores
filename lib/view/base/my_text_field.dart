  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      widget.title ? Row(children: [
        ...
        widget.isEnabled! ? const SizedBox() : Text('(${'non_changeable'.tr})', style: IBMPlexSansArabicRegular.copyWith(
          fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).colorScheme.error,
        )),

        widget.isRequired ? Text('*', style: IBMPlexSansArabicBold.copyWith(color: Theme.of(context).primaryColor)) : const SizedBox(),
