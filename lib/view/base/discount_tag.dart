...
class DiscountTag extends StatelessWidget {
  ...
  final bool isColor;
  const DiscountTag({Key? key, required this.discount, required this.discountType, this.fromTop = 10, this.fontSize, this.freeDelivery = false, this.isColor = true}) : super(key: key);
